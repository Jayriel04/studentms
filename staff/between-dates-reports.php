        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="text-align: center;">Generate Between Dates Reports</h4>
                  <form class="forms-sample" method="post" action="between-date-reportsdetails.php">
