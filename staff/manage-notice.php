                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $row) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <a href="edit-notice-detail.php?editid=<?php echo htmlentities($row->nid); ?>" class="btn btn-info btn-xs" target="_blank">Edit</a>
                                                                    <a href="manage-notice.php?delid=<?php echo htmlentities($row->nid); ?>" onclick="return confirm('Do you really want to delete?');" class="btn btn-danger btn-xs">Delete</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php $cnt++;
