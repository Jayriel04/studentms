...
<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
    ...
    <div style="padding: 30px;">
        <p>Hi {$studentName},</p>
        <p>Thank you for your recent achievement submission. After review, your submission for "<strong>{$skills}</strong>" at the <strong>{$level}</strong> level has been declined by a staff member.</p>
...
EOT;
  ...
  try {
    ...
    error_log("Staff rejection email failed to send: " . $mail->ErrorInfo);
    return false;
  }
}
