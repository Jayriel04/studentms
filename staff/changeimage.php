...
if (strlen($_SESSION['sturecmsstaffid'] == 0)) { // Ensure staff session is checked
  ...
  echo "<script>if(window.showToast) showToast('Image has an invalid format. Only jpg / jpeg / png / gif formats are allowed','warning');</script>";
      ...
      $sql = "UPDATE tblstaff SET Image=:image WHERE ID=:eid";
...
<head>
  <title>Staff Management System | Update Staff Image</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">Update Staff Image</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Update Staff Image</li>
              </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="text-align: center;">Update Staff Image</h4>
                  <hr />
                    ...
                    if ($query->rowCount() > 0) {
                      foreach ($results as $row) { ?>
                        <div class="form-group">
                          ...
                          <input type="text" name="staffname" value="<?php echo htmlentities($row->StaffName); ?>" class="form-control" readonly='true'>
                        </div>
                        <div class="form-group">
