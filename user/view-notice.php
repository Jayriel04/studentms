          ...
          <div class="content-wrapper">
            ...
            <div class="calendar-container">
              <div class="calendar-header">
                ...
                ?>
                <div>
                  <a href="?month=<?php echo $prev_month; ?>&year=<?php echo $prev_year; ?>" class="btn btn-outline-primary btn-sm">&lt; Prev</a>
                  <span style="font-weight:600; margin:0 10px;"><?php echo date('F Y', strtotime("$year-$month-01")); ?></span>
                  <a href="?month=<?php echo $next_month; ?>&year=<?php echo $next_year; ?>" class="btn btn-outline-primary btn-sm">Next &gt;</a>
                </div>
              </div>
              <div class="calendar-grid">
                <?php
                  ...
                  foreach($notices as $notice) {
                    ...
                    if (!isset($noticesByDay[$day])) $noticesByDay[$day] = [];
