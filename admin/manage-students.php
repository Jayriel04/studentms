        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <div class="d-flex">
                <a href="validate-achievements.php" class="add-btn"
                  style="text-decoration: none; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); margin-right: 10px;">✓
                  Validate</a>
                <a href="add-students.php" class="add-btn" style="text-decoration: none; margin-right: 20px;">+ Add
                  Student</a>
              </div>
            </div>
            <div class="row">
                ...
                <div class="table-card">
                  <div class="table-header">
                    ...
                    <div class="table-actions">
                      <form method="get" class="d-flex" style="gap: 12px;">
                        <input type="text" name="searchdata" class="search-box" placeholder="Search by ID, Name, or Skill"
                  ...
                  <div class="pagination">
                    <div class="pagination-info">
                      Showing <?php echo $offset + 1; ?>-<?php echo min($offset + $limit, $totalRows); ?> of
                      <?php echo $totalRows; ?> students
                    </div>
