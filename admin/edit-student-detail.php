                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) { ?>
                              ...
                              <div class="form-grid">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="placeofbirth"
                                    value="<?php echo htmlentities($row->PlaceOfBirth); ?>" class="form-control"
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="program" id="program" class="form-control" required onchange="updateMajors()">
                                    ...
                                    <option value="Bachelor of Secondary Education (BSEd)" <?php if ($row->Program == 'Bachelor of Secondary Education (BSEd)')
                                      echo 'selected'; ?>>Bachelor of Secondary Education
                                      (BSEd)</option>
                          ...
                          <div class="form-navigation">
                            ...
                            <button type="submit" class="btn btn-submit" name="submit" style="display: none;">Update
                              Student</button>
                          </div>
