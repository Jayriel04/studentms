                ...
                <div class="card-body">
                  <div class="d-sm-flex align-items-center mb-4">
                    ...
                    <form method="post" class="ml-auto">
                      <input type="text" name="searchdata" class="form-control" placeholder="Search by Name or Email" value="<?php echo htmlentities($searchdata); ?>" style="display: inline-block; width: auto;">
                        ...
                        if ($query->rowCount() > 0) {
                          foreach ($results as $row) { ?>
                            <tr>
                              ...
                              <td>
                                <a href="edit-staff-detail.php?editid=<?php echo htmlentities($row->ID); ?>" class="btn btn-xs" style="background-color: #4CAF50; color: white;">Edit</a>
                                <a href="manage-staff.php?statusid=<?php echo htmlentities($row->ID); ?>&status=<?php echo htmlentities($row->Status); ?>" class="btn btn-xs" style="background-color: #007BFF; color: white;">
