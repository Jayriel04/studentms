                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        if (!empty($searchdata)) {
                          ...
                          $sql .= " LIMIT 15"; // Default limit for pagination
                        }
                        $query = $dbh->prepare($sql);
                        if (!empty($searchdata)) {
                        ...
                        if ($query->rowCount() > 0) {
                          foreach ($results as $row) { ?>
                            <tr>
                              ...
                              <td>
                                <div>
                                  <a href="edit-notice-detail.php?editid=<?php echo htmlentities($row->nid); ?>" class="btn btn-xs" style="background-color: #4CAF50; color: white;" target="_blank">Edit</a>
                                  <a href="manage-notice.php?delid=<?php echo ($row->nid); ?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-xs" style="background-color: #FF5733; color: white;">Delete</a>
                                </div>
                              </td>
                            </tr>
                        <?php $cnt++;
